...
TRAIN_LIST = DATASET_ROOT / "train_recall_v2.txt"
HARD_LIST = DATASET_ROOT / "recall_v2_hard_negatives.txt"
RANDOM_LIST = DATASET_ROOT / "recall_v2_random_negatives.txt"
BASE_MODEL = (
    ROOT
    / "runs"
    / "segment"
...
def main():
    ...
    if args.smoke_test:
        epochs = 1
        run_name = "fracatlas_yolo11s_seg_recall_v2_smoke"
    else:
        epochs = args.epochs
        run_name = "fracatlas_yolo11s_seg_recall_v2"
    ...
    validation_name = f"{run_name}_map_best_cpu_val"
