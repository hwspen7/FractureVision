...
HARD_NEGATIVE_FILE = DATASET_ROOT / "mined_seg_hard_negatives.txt"
OUTPUT_FILE = DATASET_ROOT / "train_final_mixed.txt"
SUMMARY_FILE = DATASET_ROOT / "train_final_mixed_summary.json"
SEED = 61
