...
DATASET_ROOT = PROJECT_ROOT / "datasets" / "fracatlas_seg_yolo"
IMAGE_DIR = DATASET_ROOT / "images" / "train"
LABEL_DIR = DATASET_ROOT / "labels" / "train"

POSITIVE_FILE = DATASET_ROOT / "train_positive.txt"
MINED_HARD_FILE = DATASET_ROOT / "mined_seg_hard_negatives.txt"
OUTPUT_FILE = DATASET_ROOT / "train_recall_v2.txt"
RANDOM_NEGATIVE_FILE = DATASET_ROOT / "recall_v2_random_negatives.txt"
HARD_NEGATIVE_FILE = DATASET_ROOT / "recall_v2_hard_negatives.txt"
SUMMARY_FILE = DATASET_ROOT / "train_recall_v2_summary.json"
