...
SCORES_FILE = DATASET_ROOT / "seg_hard_negative_scores.csv"
SELECTED_FILE = DATASET_ROOT / "mined_seg_hard_negatives.txt"
SUMMARY_FILE = DATASET_ROOT / "seg_hard_negative_mining_summary.json"
