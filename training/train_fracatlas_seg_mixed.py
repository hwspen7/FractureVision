...
DATA_CONFIG = ROOT / "datasets" / "configs" / "current" / "fracatlas_seg_mixed_hard_negative.yaml"
SEGMENT_DATASET = ROOT / "datasets" / "segmentation"
TRAIN_LIST = SEGMENT_DATASET / "train_mixed_hard_negative.txt"
BASE_MODEL = (
    ROOT
    / "experiments"
    / "segmentation"
...
def main():
    ...
    if args.smoke_test:
        epochs = 1
        run_name = "mixed_training"
        validation_name = "mixed_validation"
    else:
        epochs = args.epochs
        run_name = "mixed_hard_negative"
        validation_name = "mixed_best_validation"
